...
def FName (firstName, lastName):
    # A function that will accept a value and format it to first name, last name

    fullName = firstName + " " + lastName
    return fullName

def FPhone (phoneNum):
    # A function that will accept a value and format it into a phone number

    fullNum = phoneNum [0:3] + "-" + phoneNum[3:6] + "-" + phoneNum[6:11]
    return fullNum